 ...
 * Agente 2 (Redacta):  Qwen3-32B (fallback gpt-oss-120b) escribe borrador con gancho narrativo
 * Agente 3 (Revisa):   GPT-OSS 120B fact-check + evaluación ética del ángulo
 * Agente 4 (Edita):    Qwen3-32B (fallback gpt-oss-120b) pulido editorial
...
// ── Agente 2: Qwen3-32B (fallback gpt-oss-120b) redacta el borrador con gancho narrativo ──
async function agentWrite(research, feedback = null) {
  console.log("[Agente 2/5] Qwen3-32B redactando borrador en español...");
...
// ── Agente 4: Qwen3-32B (fallback gpt-oss-120b) edita según revisión ──
async function agentEdit(draft, review) {
  console.log("[Agente 4/5] Qwen3-32B editando según revisión...\n");
